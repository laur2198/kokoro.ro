      ...
      <div class="reveal reveal--left">
        ...
        <div class="contact-info__item">
          ...
          <div>
            ...
            <p class="contact-info__text">Brașov, România<br>Str. [Adresa completă]</p>
          </div>
        </div>
        ...
        <div class="contact-info__item">
          ...
          <div>
            ...
            <p class="contact-info__text"><a href="tel:+40740123456" class="link">+40 740 123 456</a></p>
          </div>
        </div>
        ...
        <div class="contact-info__item">
          ...
          <div>
            ...
            <p class="contact-info__text"><a href="mailto:contact@kokoro.ro" class="link">contact@kokoro.ro</a></p>
          </div>
        </div>
          ...
          <form class="contact-form" method="post" action="#">
            ...
            <div class="form-group">
              ...
              <select id="subject" name="subject" class="form-select">
                ...
                <option value="inscriere">Înscriere cursuri</option>
                <option value="info">Informații generale</option>
                <option value="tarife">Tarife și abonamente</option>
...
<section class="section section--alt" style="padding: 0;">
  <div style="width: 100%; height: 400px; background: var(--color-bg-card); display: flex; align-items: center; justify-content: center;">
    <p style="color: var(--color-gray);">Google Maps — Locația Kokoro Brașov Academy</p>
  </div>
</section>
