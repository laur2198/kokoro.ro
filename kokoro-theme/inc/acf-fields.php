...
function kokoro_register_acf_field_groups() {
    ...
    /* ------------------------------------------------------------------
       -2. FAQ repeater (apare pe orice pagină sau CPT post; folosit de
           schema FAQPage și poate fi randat opțional în template-uri)
       ------------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------------
       2c. Conținut Pagină Pilon (template page-pillar.php)
           Folosit pentru paginile-pilon SEO (Ju-Jitsu copii, Autoapărare,
           TRX, Personal Trainer etc.). Toate secțiunile apar doar dacă
           câmpul _titlu corespunzător e completat — deci user-ul activează
           secțiunile pe care le vrea, în ordine fixă.
       ------------------------------------------------------------------ */
    acf_add_local_field_group([
