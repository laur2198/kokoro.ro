  ...
  <div class="container container--narrow">
    <div class="section__header reveal">
      ...
      <p style="color: var(--color-gray); margin-top: var(--space-md); line-height: 1.7;">
        Răspunsuri la cele mai des întâlnite întrebări despre personal training. Pentru întrebări specifice obiectivelor dumneavoastră, sunați la <a href="<?php echo esc_attr('tel:' . $kk_tel_e164); ?>" style="color: var(--color-accent);"><?php echo esc_html($kk_tel); ?></a>.
      </p>
    </div>
    ...
    <div class="kokoro-faq" style="display: flex; flex-direction: column; gap: var(--space-md);">
      <details class="reveal reveal-delay-1" style="background: var(--color-white); border: 1px solid rgba(13, 33, 55, 0.1); border-radius: 4px; padding: var(--space-md) var(--space-lg);">
        ...
        <div style="color: var(--color-gray); line-height: 1.8; margin-top: var(--space-md); padding-top: var(--space-md); border-top: 1px solid rgba(13, 33, 55, 0.08);">
          Tarifele variază în funcție de pachetul ales (1 ședință vs pachet 10 vs abonament lunar). Pentru detalii actualizate consultați pagina <a href="<?php echo esc_url(home_url('/tarife/')); ?>" style="color: var(--color-accent);">Tarife</a> sau sunați la <a href="<?php echo esc_attr('tel:' . $kk_tel_e164); ?>" style="color: var(--color-accent);"><?php echo esc_html($kk_tel); ?></a>. Prima ședință de evaluare este întotdeauna <strong>gratuită</strong>.
        </div>
      </details>
...
<script type="application/ld+json">
{
  ...
  "provider_mention": {
    "@id": "<?php echo esc_url(kokoro_antrenor_canonical_id('sempai-adrian')); ?>"
  }
}
</script>
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tarifele variază în funcție de pachetul ales (1 ședință vs pachet 10 vs abonament lunar). Pentru detalii actualizate consultați pagina Tarife sau sunați la <?php echo esc_html($kk_tel); ?>. Prima ședință de evaluare este întotdeauna gratuită."
      }
    },
    {
      "@type": "Question",
