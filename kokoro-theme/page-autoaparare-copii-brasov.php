...
<section class="page-header">
  <div class="container">
    ...
    <h1><?php
      ...
      else { ?>AUTOAPĂRARE<br>PENTRU <em>COPII</em><br>ÎN BRAȘOV<?php }
    ?></h1>
...
<section class="section section--alt" id="faq">
  <div class="container container--narrow">
    <div class="section__header reveal">
      ...
      <p style="color: var(--color-gray); margin-top: var(--space-md); line-height: 1.7;">
        Răspunsuri la cele mai des întâlnite întrebări ale părinților despre cursul de autoapărare. Pentru situații specifice, sunați la <a href="<?php echo esc_attr('tel:' . $kk_tel_e164); ?>" style="color: var(--color-accent);"><?php echo esc_html($kk_tel); ?></a>.
      </p>
    </div>
